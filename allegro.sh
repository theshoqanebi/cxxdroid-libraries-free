#!/usr/bin/sh
printf "\e[36m%s\e[0m\n" "Cxxdroid Allegro Library Installation:-"
...
case `arch` in
	...
	*)
		printf "\e[30m%s\e[0m\n" "Unsuppored";
		printf "\e[30m%s\e[0m\n" "* allegro library installation faild )-:"
		exit 1 ;;
	esac
printf "\e[35m%s" "* Downloading Files: "
wget "https://cxxdroid-libraries-free.herokuapp.com/?lib=allegro&arch=${archurl}" -O "/data/user/0/ru.iiec.cxxdroid/app_HOME/allegro-${archurl}.tar.xz" >/dev/null 2>&1
printf "\e[32m%s\n" "Done"
...
printf "\e[32m%s\e[0m\n" "* Allegro library installed successfully (-:"
